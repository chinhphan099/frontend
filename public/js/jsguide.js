  ...
  Plugin.prototype = {
    ...
    defineOption: function () {
      ...
      this.option = {
        ...
        onImageClick: function () {//console.log('onImageClick');
        },
        ...
        onImageSwap: function () {//console.log('onImageSwap');
        },
        onImageSwapComplete: function () {//console.log('onImageSwapComplete');
        }
      };
